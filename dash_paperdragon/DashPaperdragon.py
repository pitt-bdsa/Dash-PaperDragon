...
- zoomLevel (number; optional):
    ...
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, config=Component.UNDEFINED, tileSources=Component.UNDEFINED, zoomLevel=Component.UNDEFINED, curMousePosition=Component.UNDEFINED, viewportBounds=Component.UNDEFINED, outputFromPaper=Component.UNDEFINED, inputToPaper=Component.UNDEFINED, tileSourceProps=Component.UNDEFINED, baseImageWidth=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'baseImageWidth', 'config', 'curMousePosition', 'inputToPaper', 'outputFromPaper', 'tileSourceProps', 'tileSources', 'viewportBounds', 'zoomLevel']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'baseImageWidth', 'config', 'curMousePosition', 'inputToPaper', 'outputFromPaper', 'tileSourceProps', 'tileSources', 'viewportBounds', 'zoomLevel']
